...
# @Project: Coursera
# @Filename : Exercise_3_Improve_MNIST.py

#In the videos you looked at how you would improve Fashion MNIST using Convolutions.
# For your exercise see if you can improve MNIST to 99.8% accuracy or more using only a single convolutional
# layer and a single MaxPooling 2D.
#
